...
public abstract class Validation {
     ...
     * @return true表示通过
     */
    public abstract boolean validate(String filedName, String[] values, String[] parameters);
     ...
     * @return 完整错误信息
     */
    public abstract String error(String filedName, Map<String, String[]> rule, String[] parameters);
